...
namespace ANS_Library_Management_System {
    ...
    public class Book_Report : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "ANS_Library_Management_System.Book Report.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedBook_Report : Component, ICachedReport {
        
        public CachedBook_Report() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Book_Report rpt = new Book_Report();
            rpt.Site = this.Site;
            return rpt;
        }

...
values (@ID,@username,@password,@usertype,@First_Name,@Middle_Name ,@Last_Name ,@Address ,@Contact_Number ,@Gender,@Birthdate ,@Age ,@Section,@Grade_Level ,@Email_Address ,@Security_Question ,@Security_Answer)
...
as
select ID,First_Name,Middle_Name,Last_Name,Address,Contact_Number,Gender,Birthdate,Age,Section,Grade_Level,Email_Address
from tblUserDetails
...
values (@ID,@username,@password,@usertype,@First_Name,@Middle_Name ,@Last_Name ,@Address ,@Contact_Number ,@Gender,@Birthdate ,@Age ,@Email_Address ,@Security_Question ,@Security_Answer)
drop procedure sp_DeleteAdmin
--ADMIN UPDATE
...
set ID=@ID,username=@username,password=@password,usertype=@usertype,First_Name=@First_Name,Middle_Name=@Middle_Name ,Last_Name=@Last_Name ,Address=@Address ,Contact_Number=@Contact_Number ,Gender=@Gender,Birthdate=@Birthdate ,Age=@Age ,Email_Address=@Email_Address ,Security_Question=@Security_Question ,Security_Answer=@Security_Answer
...
--USER SEARCH
create procedure sp_AdminSearch
(
	@SearchKey varchar(50)
)
as
select ID,First_Name,Middle_Name,Last_Name,Address,Contact_Number,Gender,Birthdate,Age,Email_Address
from tblAdminDetails
where tblAdminDetails.ID = @SearchKey or tblAdminDetails.Last_Name=@SearchKey
